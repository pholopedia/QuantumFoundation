...
export class FooterComponent implements OnInit {
  ...
  hexes = [
    ...
    { website:"holopedia",          link:"http://holopedia.li/", text:"Holopedia", extension:"gif", facebook_id:"Holopedia_749113741936284", twitter_id:"HolopediaQuant", wordpress_id:"holopedia", simplesite_id:"holopedia", website_description:"Holopedia is a video based encyclopedia that offers intuitive explanation and extensive information in areas such as quantum holoportation and holographic reality in electromagnetic, quantum and gravitational dimensions."},
    ...
    { website:"graphene-quantec",   link:"https://graphenequantec.wordpress.com/", text:"Graphene Quantec", facebook_id:"graphenenews", twitter_id:"graphenequantec", youtube_id:"UCKzqiHSuMkf_emEB_XWp6Xg", wordpress_id:"graphenequantec", website_description:"Graphene QuantumTechnology is based on the use of graphene applications for the advancement of Graphene Quantum Technology Computers, Sensors, Graphene Quantum Tunnelling Composites, Graphene Quantum Dots, Electrotribology, Tribology, Tribotronics."},
